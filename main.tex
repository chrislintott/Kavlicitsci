...
% "we need to explore" is perhaps not ideal wording given we've just had a multi-day workshop designed to explore. 
...
\item Data produced by a citizen science project should (after a suitable time) be made public. %The parenthetical statement here seems to be in contradiction with the commensality argument unless we explain it further. Perhaps the definition of "a suitable time" should depend on the urgency of the science case, to ensure the scientific community can make effective use of the data set. 
